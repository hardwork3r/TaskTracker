...
TaskManager - это веб-платформа для управления задачами с поддержкой ролей, Kanban-доски, файловых вложений и гибкой системой назначения пользователей. Проект построен на микросервисной архитектуре с раздельным frontend и backend.
